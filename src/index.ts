...
const sofjsUtil = require('sofjs-util')
 ...
 */
export const KECCAK256_SSRLP_ARRAY_S: string =
  '1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347'

/**
 * Keccak-256 of an SSRLP of an empty array
 */
export const KECCAK256_SSRLP_ARRAY: Buffer = Buffer.from(KECCAK256_SSRLP_ARRAY_S, 'hex')

/**
 * Keccak-256 hash of the SSRLP of null
 */
export const KECCAK256_SSRLP_S: string =
  '56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421'

/**
 * Keccak-256 hash of the SSRLP of null
 */
export const KECCAK256_SSRLP: Buffer = Buffer.from(KECCAK256_SSRLP_S, 'hex')
 ...
 */
export const srlphash = function(a: srlp.Input): Buffer {
  return keccak(srlp.encode(a))
}
...
export const hashPersonalMessage = function(message: any): Buffer {
  const prefix = toBuffer(`\u0019Sophon Signed Message:\n${message.length.toString()}`)
...
export const generateAddress = function(from: Buffer, nonce: Buffer): Buffer {
  ...
  if (nonceBN.isZero()) {
    // in SSRLP we want to encode null in the case of zero nonce
    // read the SSRLP documentation for an answer if you dare
    return srlphash([from, null]).slice(-20)
  }

  // Only take the lower 160bits of the hash
  return srlphash([from, Buffer.from(nonceBN.toArray())]).slice(-20)
}
